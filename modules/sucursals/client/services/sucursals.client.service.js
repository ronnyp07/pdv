...
(function () {
  ...
  sucursalModel.service('SucursalsRestServices',  ['$q', '$http', '$timeout', 'SucursalsService', 'Authentication', '$rootScope', 'Security', '$state', 'SucursalListServices', function($q, $http, $timeout, SucursalsService, Authentication, $rootScope, Security, $state, SucursalListServices){
    var self ={
     'sucursals': {},
     'tempAncestors': [],
     'sucursalsList': [],
     ...
     'isLoading': false,
     'carList': [],
     //get sucursal list by the company Id
     //end point sucursals/routes
     'getSucursalByCompany': function(company){
      var result = [];
      var defer = $q.defer();
      $http.get('/api/sucursalList', {params: {companyId: company}}).success(function(response) {
