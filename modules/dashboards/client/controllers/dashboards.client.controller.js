(function () {
  ...
  DashboardsController.$inject = ['$scope', '$state', 'Authentication', 'dashboardResolve', '$rootscope'];

  function DashboardsController ($scope, $state, Authentication, dashboard, $rootscope) {
    var vm = this;
