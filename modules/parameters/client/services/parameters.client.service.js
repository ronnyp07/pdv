...
(function () {
  ...
  parametersModule.service('ParameterRestServices',  ['$q', '$http', '$timeout', 'parametersService', function($q, $http, $timeout, parametersService){
     ...
     'paramEnum':{
       inventoryStatus: {
         ...
         cerrado: 'Cerrado'
           ...
           producto : 'producto',
           marca: 'marca'
       // { name: 'Almacen', checked: false, model: 'almacenId'},
       // { name: 'Operaciones Diarias', checked: false, model: 'OpDiarias'},
       // { name: 'Configuración', checked: false, model: 'Config'}
       },'subMenu' :
       {  categoria: 'categoria',
       ...
       { _id : 'Eliminar Producto', parent: 'Producto' },
       { _id : 'Agregar Producto', parent: 'Producto' },
       { _id : 'Editar Producto', parent: 'Producto' },
       { _id : 'Actualizar Producto', parent: 'Producto'}
       ],
       headers: {
    ...
    {code: '01', desc : 'Comprobante con Valor Fiscal', shortDesc: 'Valor Fiscal'},
    {code:'02', desc: 'Factura a Consumidor Final', shortDesc: 'Consumidor Final'},
    {code:'03', desc: 'Notas de Débitos', shortDesc: 'Notas de Débitos'},
    {code:'04', desc:'Notas de Creditos', shortDesc: 'Notas de Creditos'},
    {code:'14', desc:'Comprobante para Régimen Especial', shortDesc: 'Régimen Especial'},
    {code:'15', desc:'Comprobante Fiscal Gubernamental', shortDesc: 'Gubernamental'},
    {code:'11', desc: 'Comprobante para Proveedores Informales', shortDesc: 'Proveedor Informal'},
    {code:'13', desc: 'Comprobantes para Gastos Menores', shortDesc: 'Gastos Menores'},
    {code:'12', desc: 'Comprobantes de Registro Único de Ingresos', shortDesc: 'Único de Ingresos'}
    ],
    'tempAncestors': [],
    'tempParent': null,
    'parameter': null,
