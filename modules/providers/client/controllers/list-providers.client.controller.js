...
.controller('ProvidersListController', ['providersService', '$scope', 'ProviderRestServices', '$http', '$q', 'NgTableParams', '$modal', 'Authentication',  function ProvidersListController(providersService, $scope, ProviderRestServices, $http, $q, NgTableParams, $modal, Authentication ) {
